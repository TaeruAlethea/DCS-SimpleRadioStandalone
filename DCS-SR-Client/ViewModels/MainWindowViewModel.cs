...
namespace Ciribob.DCS.SimpleRadio.Standalone.Client.ViewModels
{
    ...
    public partial class MainWindowViewModel : ObservableObject
    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (ip != null)
                    {
                        ...
                        VisualStyleElement.StartPanel.Preview.IsEnabled = false;

                        if (_audioPreview != null)
                        {
                            VisualStyleElement.StartPanel.Preview.Content = Properties.Resources.PreviewAudio;
        ...
        public void Stop(bool connectionError = false)
        {
            ...
            VisualStyleElement.StartPanel.Preview.IsEnabled = true;
            ClientState.IsConnected = false;
            ToggleServerSettings.IsEnabled = false;
        ...
        private void PreviewAudio(object sender, RoutedEventArgs e)
        {
            if (_audioPreview == null)
            {
                ...
                try
                {
                    ...
                    VisualStyleElement.StartPanel.Preview.Content = Properties.Resources.PreviewAudioStop;
                }
                catch (Exception ex)
                {
                    Logger.Error(ex,
            ...
            {
                VisualStyleElement.StartPanel.Preview.Content = VisualStyleElement.StartPanel.Preview.Content = Properties.Resources.PreviewAudio;
                _audioPreview.StopEncoding();
                _audioPreview = null;
            }
        }
