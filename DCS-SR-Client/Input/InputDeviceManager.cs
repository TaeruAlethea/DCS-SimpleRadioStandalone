...
public class InputDeviceManager : IDisposable
{
	...
	private void PollDevices(List<InputBindState> states)
	{
		...
		{
			if (inputBindState.MainDevice != null) uniqueDevices.Add(inputBindState.MainDevice.InstanceGuid);
			if (inputBindState.ModifierDevice != null) uniqueDevices.Add(inputBindState.ModifierDevice.InstanceGuid);
		}
