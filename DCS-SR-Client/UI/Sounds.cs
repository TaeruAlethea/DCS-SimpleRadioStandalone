...
public static class Sounds
{
	...
	public static void Init()
	{
		...
		BeepConnected =
			new SoundPlayer(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "AudioEffects", "beep-connected.wav"));
		// Audio file taken from https://freesound.org/people/pan14/sounds/263123/ @ 2018-10-03
		BeepDisconnected = new SoundPlayer(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "AudioEffects",
