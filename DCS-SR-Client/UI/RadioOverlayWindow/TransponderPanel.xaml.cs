...
public partial class TransponderPanel : UserControl
{
	...
	public void RepaintTransponderStatus()
	{
		...
		if (dcsPlayerRadioInfo == null || !dcsPlayerRadioInfo.IsCurrent() || dcsPlayerRadioInfo.iff == null ||
		    dcsPlayerRadioInfo.iff.control == Common.DCSState.Transponder.IFFControlMode.DISABLED)
		{
	...
	private bool CanInteract()
	{
		...
		if (trans == null || trans.control != Common.DCSState.Transponder.IFFControlMode.OVERLAY) return false;
