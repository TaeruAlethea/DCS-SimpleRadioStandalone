...
{
	public static bool
		AwacsActive; //when false and we're in spectator mode / not in an aircraft the other 7 radios will be disabled
	...
	private void RadioRefresh(object sender, EventArgs eventArgs)
	{
		...
		if (dcsPlayerRadioInfo != null)
		{
			if (_clientStateSingleton.IsConnected && dcsPlayerRadioInfo.IsCurrent()
			                                      && _clientStateSingleton.DcsPlayerRadioInfo
				                                      .simultaneousTransmissionControl == DCSPlayerRadioInfo
