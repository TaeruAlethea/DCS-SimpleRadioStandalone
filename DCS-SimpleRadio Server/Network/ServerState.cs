	...
	IHandle<BanClientMessage>
{
	...
	private readonly ConcurrentDictionary<string, SRClient> _connectedClients = new();
				...
				while (!_stop)
				{
					try
					{
						    ...
						    .BoolValue)
						{
							...
							var firstSeatDict = new Dictionary<uint, SRClient>();
							var secondSeatDict = new Dictionary<uint, SRClient>();
